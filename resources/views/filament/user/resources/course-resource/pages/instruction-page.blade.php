<x-filament-panels::page>
    ...
    <div
        ...
        <div class="text-center my-8">
            ...
            <p class="text-gray-600 dark:text-gray-400 md:text-md text-sm mb-4">Ensure you've gone through the course material thoroughly
            ...
            <div class="flex justify-center gap-10 mb-4">
                <div>
                    ...
                    <p class="text-md sm:text-3xl font-bold text-gray-800 dark:text-white">{{ $numberOfQuestions }}</p>
                </div>
                <div>
                    <p class="text-md sm:text-lg text-gray-500">Time</p>
                    <p class="text-md sm:text-3xl font-bold text-gray-800 dark:text-white">{{ $course->duration }} Minutes</p>
                </div>
                <div>
            ...
            <p class="md:text-md text-sm text-gray-500 dark:text-gray-400">Good luck, and remember to review your answers before submitting
                your final exam.</p>
        </div>
