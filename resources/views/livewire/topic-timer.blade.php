<div>
    <div wire:ignore x-data="{
            ...
            if (this.remainingTime !== null) {
                ...
                this.intervalId = setInterval(() => {
                    if (this.remainingTime > 0) {
                        ...
                        this.$dispatch('timeUp'); // This event should be handled in Livewire to submit the question
                    }
                }, 1000);
            }
        },
        ...
        <div class="flex items-center justify-center space-x-2">
            <span>Time left:</span>
            <span x-text="formatTime(hours) + ':' + formatTime(minutes) + ':' + formatTime(seconds)"
